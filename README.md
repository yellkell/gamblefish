...
| `src/audio/` | ff2's synth SFX bus and cash chime; Tidewater's sampled fishing sounds |
...
- **Teleport, cash chime, coin symbol and type kit:** from FIRE FIGHT 2. Rajdhani
