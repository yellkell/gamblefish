...
export const ROLES: Record<string, BuildingRole> = {
  // ── the casinos (roulette, slots, blackjack) and the high-rollers' room ──
  ...
  M: { role: 'casino', title: "CAPTAIN'S TABLE", sub: 'HIGH ROLLERS', colour: '#ffb000', does: 'high-rollers' },

  // ── the shops ──
  stall: { role: 'shop', title: 'FISH MARKET', sub: 'we buy your catch', colour: '#2f6fa8', does: 'sell fish' },
  S3: { role: 'shop', title: 'TACKLE SHOP', sub: 'rods · reels · line', colour: '#c23b2e', does: 'rod, reel and line upgrades' },
  S2: { role: 'shop', title: 'BAIT SHOP', sub: 'live bait', colour: '#3f7f55', does: 'bait' },
  boathouse: { role: 'shop', title: 'BOATYARD', sub: 'chandlery · fuel', colour: '#2f6fa8', does: 'boat, fuel, fish finder, bigger backpack' },
  A: { role: 'shop', title: 'JEWELLER', sub: 'gifts that sparkle', colour: '#8a5ac2', does: 'jewellery (gifts)' },
  D: { role: 'shop', title: 'FLORIST', sub: 'fresh every morning', colour: '#d8508a', does: 'flowers (gifts)' },
  E: { role: 'shop', title: 'BOUTIQUE', sub: 'dress to impress', colour: '#2f8a8a', does: 'outfits' },
  H: { role: 'shop', title: 'ISLAND BANK', sub: 'coins & credit', colour: '#b08d4a', does: 'buy coins' },
  I: { role: 'shop', title: 'RUM SHACK', sub: 'open late', colour: '#8a4a2a', does: 'drinks' },
  ...
  N: { role: 'shop', title: 'FORTUNE TELLER', sub: 'luck charms', colour: '#5a3a8a', does: 'luck charms' },
